...
const ProposalTabContent = dynamic(() => import("@/components/proposalView/ProposalTabContent"), {
  ssr: false,
});
const ProposalSent = dynamic(() => import("@/components/proposalEditCreate/ProposalSent"), {
  ssr: false,
});
const page = () => {
  return (
