...
const categoryData = [
  {
    ...
    topics: [
      ...
      "Step by Step Intigrations Guide",
    ],
    ...
    <>
      ...
      <div className="main-content container-lg px-4 help-center-main-contet-area overflow-visible">
        <div className="row help-quick-card">
          <HelpCard
            description={
              "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sequi, veniam. Modi quas vero odit asperiores alias libero quae in quam dicta autem et repudiandae ex, molestiae doloremque, explicabo reiciendis minus?"
            }
        ...
        <section className="topic-category-section">
          <div className="d-flex flex-column align-items-center justify-content-center mb-5">
            ...
            <p className="px-5 mx-5 text-center text-muted text-truncate-3-line">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus laboriosam obcaecati
              fuga repellat animi quam nesciunt maiores dolorem corporis debitis incidunt,
              accusantium corrupti dignissimos repellendus, saepe accusamus expedita necessitatibus.
            </p>
          </div>
          <div className="row">
    ...
    <div className="card p-4 mb-4">
      <div className="d-sm-flex align-items-center">
        ...
        <div className="ms-0 ms-sm-3 mt-4 mt-sm-0">
          ...
          <span className="fs-10 fw-semibold text-uppercase text-muted">
            {totalTopic} topics category
          </span>
        </div>
      </div>
      <ul className="list-unstyled mb-0 mt-4 ms-sm-5 ps-sm-3">
        {topics.map((topic, index) => (
          <li key={index} className="mb-2">
            <i className="feather-file-text me-2 fs-13">
              <FiFileText />
            </i>
            <a
              href="#"
  ...
  return (
    <div className="col-lg-4">
      <div className="card card-body pb-0 pb-lg-4 text-center">
        <a
          href={link}
          className="card stretch stretch-full p-5 mb-4 mb-lg-0 d-flex flex-column flex-fill align-items-center justify-content-center border rounded-3"
        >
          ...
          {description && (
            <div className="fs-12 fw-medium text-muted text-truncate-1-line">{description}</div>
          )}
        </a>
      </div>
    </div>
