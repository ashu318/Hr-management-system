        ...
        <div className="col-xxl-10">
          <div className="row g-4">
            <ProjectCard
              ...
              description={
                "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sint nam ullam iure eum sed rerum libero quis doloremque maiores veritatis?"
              }
            />
            <ProjectCard
