  ...
  const predefinedRanges = [
    {
      ...
      isSelected: (range) =>
        isSameDay(range.startDate, new Date()) && isSameDay(range.endDate, new Date()),
    },
    {
      label: "Yesterday",
      range: () => ({
      ...
      isSelected: (range) =>
        isSameDay(range.startDate, addDays(new Date(), -1)) &&
    ...
    },
    {
      ...
      isSelected: (range) =>
        isSameDay(range.startDate, addDays(new Date(), -new Date().getDay())) &&
        isSameDay(range.endDate, addDays(new Date(), 6 - new Date().getDay())),
    },
    {
      label: "Last Week",
      range: () => ({
      ...
      isSelected: (range) =>
        isSameDay(range.startDate, addDays(new Date(), -new Date().getDay() - 7)) &&
        isSameDay(range.endDate, addDays(new Date(), -new Date().getDay() - 1)),
    },
    {
      label: "This Month",
      range: () => ({
