            ...
            {replies.length ? (
              <div className="ms-4">
                <div className="ms-4">
                  {replies
                    .slice(0, 2)
                    .map(({ replie, like, time, user_img, user_name, replies }, index) => (
                      <CommentCard
                        key={index}
                        user_img={user_img}
                        user_name={user_name}
  ...
  return (
    <div className="d-flex mb-4">
      <div className="avatar-image me-3">
        <a href="#">
          <img src={user_img} className="img-fluid" alt="" />
        </a>
      </div>
      <div className="">
        <a href="#" className="mb-1 d-flex align-items-center">
          <span>{user_name}</span>
          <span className="wd-3 ht-3 bg-gray-500 rounded-circle d-flex mx-2 d-none d-sm-block" />
          <span className="fs-10 text-uppercase text-muted d-none d-sm-block">{time}</span>
        </a>
