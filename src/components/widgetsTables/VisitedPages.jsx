              ...
              <tbody>
                {tableData.map((data, index) => (
                  <tr key={index}>
                    ...
                    <td>
                      <span
                        className={`align-middle material-symbols-rounded ms-1 text-${data.status === "up" ? "success" : "danger"}`}
                      >
                        {data.percentage}
                      </span>
                      <i
                        className={`feather-arrow-${data.status} text-${data.status === "up" ? "success" : "danger"} fs-12 ms-1`}
                      ></i>
                    </td>
                  </tr>
                ))}
