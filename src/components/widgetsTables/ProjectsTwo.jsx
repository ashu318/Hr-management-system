                ...
                {data.map(
                  ({
                    ...
                    <tr key={id}>
                        ...
                        <div className="hstack gap-4">
                          ...
                          <div>
                            ...
                            <div className="fs-12 text-muted">
                              ...
                              <a
                                href="#"
                                className="fw-normal text-muted border-bottom border-bottom-dashed"
                              >
                                {project_owner}
                              </a>
                            </div>
                      ...
                      <td>
                        <span className="fw-bold text-dark">${budgets} USD</span>
                      </td>
                      <td>
                        <div className="hstack gap-1">{getProgressBar(progress)}</div>
                      </td>
                      <td>
                        <div className={`badge bg-soft-${badgeColor} text-${badgeColor}`}>
                          {status}
                        </div>
                      </td>
                      <td>
