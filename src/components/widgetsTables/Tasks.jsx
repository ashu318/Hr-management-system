...
const tasksData = [
  ...
  {
    taskNumber: "04",
    taskName: "Duralux public pnnouncement ",
    taskDate: "20/02/2023",
    taskDescription: "Lorem ipsum dolor, sit amet consectetur adipisicing elit.",
    status: taskStatusOptions,
    priority: taskPriorityOptions,
          ...
          <div className="table-responsive tasks-items-wrapper">
            <table className="table table-hover mb-0">
              ...
              <tbody>
                {tasksData.map(
                  (
                    { taskDate, taskDescription, taskName, taskNumber, assignee, priority, status },
                    index
                  ) => {
                    ...
                    return (
                      <tr key={index}>
                        ...
                        <td>
                          <a href="#">
                            {taskName}{" "}
                            <span className="fs-12 fw-normal text-muted">({taskDate})</span>{" "}
                          </a>
