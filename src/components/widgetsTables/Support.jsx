...
const supportData = [
  {
    ...
    message: "My item doesn't ship to correct address",
    avatar: "/images/avatar/1.png",
    time: "2 hours ago",
  },
  {
    name: "Green Cute",
    message: "Can you please refund back my money",
    avatar: "/images/avatar/2.png",
    time: "3 hours ago",
  },
  {
    name: "Marianne Audrey",
    message: "You shipped the wrong color, I need it to be",
    avatar: "/images/avatar/3.png",
    time: "4 hours ago",
  },
  {
    name: "Holland Scott",
    message: "Thank you very much for quick support!",
              ...
              <tbody>
                {supportData.map((data, index) => (
                  <tr key={index}>
                    ...
                    <td>
                      <a href="#" className="btn btn-sm bg-soft-primary text-primary">
                        {data.time}
                      </a>
                    </td>
                  </tr>
