...
const campaignData = [
  {
    ...
    link: "http://ads.facebook.com/#campaign",
    target: "50K",
    reach: "46.44K",
    progress: 92,
    status: "Active",
  ...
  {
    brand: "Gmail",
    image: "/images/brand/gmail.png",
    link: "http://ads.google.com/#campaign",
    target: "30K",
    reach: "22.82K",
    progress: 82,
    status: "Paused",
  ...
  },
  {
    ...
    link: "http://ads.twitter.com/#campaign",
    target: "40K",
    reach: "35.2K",
    progress: 88,
    status: "Active",
  ...
  {
    brand: "Pinterest",
    image: "/images/brand/pinterest.png",
    link: "http://ads.pinterest.com/#campaign",
    target: "60K",
    reach: "55.1K",
    progress: 91,
    status: "Active",
  ...
  },
  {
    ...
    link: "http://ads.instagram.com/#campaign",
    target: "25K",
    reach: "18.6K",
    progress: 74,
    status: "Paused",
                  ...
                  <tr key={index}>
                    ...
                    <td>
                      ...
                      <div className="progress ht-3">
                        <div
                          className={`progress-bar bg-${campaign.color}`}
                          role="progressbar"
                    ...
                    <td className="text-end">
                      <span className={`badge bg-soft-${campaign.color} text-${campaign.color}`}>
                        {campaign.status}
                      </span>
                    </td>
                    <td className="text-end">
