                ...
                {leadsStatusData.map(({ date, id, img, name, status, value, badgeColor }) => (
                  <tr key={id} className="leads-status">
                    <td className="position-relative">
                      <div
                        className={`ht-50 position-absolute start-0 top-50 translate-middle rounded border-start border-5 border-${badgeColor}`}
                      ></div>
                      <Link href="#">{name}</Link>
                    </td>
                    <td>
                    ...
                    <td>{date}</td>
                    <td>
                      <Link href="#" className={`badge bg-soft-${badgeColor} text-${badgeColor}`}>
                        {status}
                      </Link>
                    </td>
                    <td>
