...
const actionOptions = [{ label: "View User" }, { label: "Delete User" }];
const customerData = [
  {
    name: "Alexandra Della",
    email: "alex.della@email.com",
  ...
  },
  {
    ...
    email: "valentine.maton@email.com",
    avatar: "/images/avatar/2.png",
    flag: "/images/flags/1x1/gb.svg",
  ...
  {
    name: "Malanie Hanvey",
    email: "malanie.hanvey@email.com",
  ...
  },
  {
    ...
    email: "archie.cantones@email.com",
