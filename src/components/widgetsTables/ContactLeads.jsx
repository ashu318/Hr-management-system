...
const contactData = [
  ...
  {
    name: "Malanie Hanvey",
    email: "malanie.hanvey@emial.com",
  ...
  },
  {
    ...
    email: "valentine.maton@emial.com",
                ...
                {contactData.map((contact, index) => (
                  <tr key={index} className="">
                    <td className={`position-relative`}>
                      <div
                        className={`ht-50 position-absolute start-0 top-50 translate-middle border-start border-5 border-${contact.color}`}
                      />
                    ...
                    <td>
                      <a
                        href="#"
                        className={`badge bg-soft-${contact.color} text-${contact.color}`}
                      >
                        {contact.status}
                      </a>
                    </td>
                    <td>
                      <a href="#">{contact.amount}</a>
                    </td>
                  </tr>
                ))}
              </tbody>
