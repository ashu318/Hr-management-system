...
const summaryData = [
  ...
  {
    invoiceNumber: "#478523",
    avatar: "/images/avatar/2.png",
    name: "Green Cute",
    email: "green.cute@hotmail.com",
    code: "SU56HD246K",
    date: "28-02-2023",
  ...
  {
    invoiceNumber: "#558746",
    avatar: "/images/avatar/5.png",
    name: "Gregory Miller",
    email: "gregory.miller@live.com",
    code: "SU56HD246K",
    date: "28-02-2023",
    icon: "fa-cc-mastercard",
    cardType: "Mastercard",
          ...
          <div className="table-responsive">
            <table className="table table-hover mb-0">
              ...
              <tbody>
                {summaryData.map(
                  (
                    { avatar, icon, cardType, code, date, email, invoiceNumber, name, status },
                    index
                  ) => {
                    ...
                    return (
                      <tr key={index}>
                        ...
                        <td>{date}</td>
                        <td>
                          <i className={`me-1 fs-18`}>{getIcon(icon)}</i>
                          {cardType}
                        </td>
                        <td>
                          <SelectDropdown
