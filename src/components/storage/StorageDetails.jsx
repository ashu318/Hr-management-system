        ...
        <div className="tab-content">
          <div className="tab-pane fade active show" id="fileDetailsTab">
            <div className="p-4 d-flex align-items-center justify-content-center">
              <img src="/images/storage-icons/undefined.png" className="img-fluid wd-200" alt="" />
            </div>
            ...
            <div className="drive-settings">
              ...
              <div className="p-4">
                <SettingsChecbox
                  ...
                  description={"Lorem ipsum quia dolor sit amet adipisci quia dolor"}
                />
                <SettingsChecbox
                  id={"autoBackup"}
                  checked={true}
    ...
    <div className="form-group mb-4">
      <div className="form-item custom-control custom-checkbox checkbox-primary">
        <input
          ...
          onChange={onChange}
        />
        <label className="custom-control-label ps-2" htmlFor={id}>
          <span className="fw-semibold" style={{ marginTop: "-5px" }}>
            {label}
          </span>
          <span className="fs-11 fw-normal text-muted text-truncate-1-line">{description}</span>
        </label>
      </div>
    </div>
  );
    ...
    <div className="d-flex justify-content-between align-items-center mb-4">
      <div className="d-flex align-items-center">
        ...
        <div className="ms-3">
          ...
          <span className="fs-11 fw-normal text-muted">{fileCount} Files</span>
        </div>
      </div>
