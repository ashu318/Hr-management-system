      ...
      <div className="offcanvas-body">
        <div className="p-lg-5 mx-lg-5 help-center details-content-body">
          ...
          <p className="fs-12 text-muted">
            Last Updates: <span className="text-dark fw-medium">26 May, 2024</span>
          </p>
          <hr className="my-4" />
          <h4 className="fs-14">Hey there...!!!</h4>
          <p className="text-muted">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Assumenda consectetur illo at
            placeat cum nulla repellat expedita nostrum praesentium blanditiis repudiandae commodi
            tempore debitis odio, doloremque magni eaque soluta cupiditate ullam harum,
            necessitatibus sunt voluptas eum laboriosam. Consequatur nobis fuga fugiat deleniti
          ...
          <ul className="text-muted my-4">
            ...
            <li className="mb-2">
              <strong className="text-dark">Step by Step</strong> Intigrations Guide
            </li>
            <li className="mb-2">
              <strong className="text-dark">Add favorite</strong> for quick and messaging
            </li>
            <li className="mb-2">
              <strong className="text-dark">Fine-tune</strong> your notifications to focus on that
              matters
            </li>
            <li>
              <strong className="text-dark">Trigger your inbox</strong> and own your email
              experience
            </li>
          </ul>
          <div className="mt-5">
            ...
            <ul className="list-unstyled">
              ...
              <li className="d-flex align-items-center mb-2">
                ...
                <span>
                  We care about your Privacy in our <a href="#">Privacy &amp; Policy</a>.
                </span>
              </li>
              <li className="d-flex align-items-center">
                ...
                <span>
                  By clicking allow access, your authorize untitled to access your informations.
                </span>
              </li>
            </ul>
          </div>
          <div className="mb-5">
            <pre>
              <code className="language-html">
                ...
                {"    "}&lt;!--! The above 6 meta tags *must* come first in the head; any other head
          ...
          <p className="text-muted mb-4">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque officiis minus omnis
            veniam cupiditate molestiae itaque hic quibusdam fuga modi quam cumque recusandae harum
            nulla vero, tempore possimus aliquid animi!
          </p>
          <div className="mb-5">
            <pre>
              <code className="language-js">
                ...
                {"\n"}
                {"                                "}// The code snippet you want to highlight, as a
                string{"\n"}
                {"                                "}const code = `var data = 1;`;{"\n"}
                {"\n"}
                {"                                "}// Returns a highlighted HTML string{"\n"}
                {"                                "}const html = Prism.highlight(code,
