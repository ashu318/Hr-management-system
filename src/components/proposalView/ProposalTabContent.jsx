      ...
      <div className="row">
        ...
        <div className="col-lg-12">
          <div className="card stretch stretch-full">
            ...
            <div className="card-body">
              <div className="accordion proposal-faq-accordion" id="accordionFaqGroup">
                {accordionData.map(({ ans, id, qustion }) => (
                  <AccordionItem key={id} id={id} header={qustion} content={ans} />
                ))}
              </div>
            </div>
          </div>
...
const ServiceCard = ({ icon, title, description, link }) => {
  return (
    <div className="col-xxl-4 col-md-6">
      <div className="card stretch stretch-full">
        <div className="card-body">
          <div className="avatar-text rounded-2 mb-4">{getIcon(icon)}</div>
          <h6 className="fw-bold mb-3 text-truncate-1-line">{title}</h6>
          <p className="text-muted mb-4 text-truncate-3-line">{description}</p>
          <a href={link} className="d-block fs-10 fw-bold text-dark text-uppercase text-spacing-1">
            Learn More →
          </a>
        </div>
      </div>
