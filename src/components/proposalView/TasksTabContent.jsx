        ...
        <div className="col-xxl-8 col-xl-6">
          <div className="card stretch stretch-full">
            ...
            <div className="card-body">
              <p>
                Web Design Company is still a broad term and refers to any company that specializes
                in designing and creating websites. These companies typically offer a range of
                services including website design, development, and maintenance. They may also offer
                other related services such as search engine optimization (SEO), e-commerce
                solutions, and website hosting.
              </p>
              <ul className="list-unstyled text-muted mb-0">
                <li className="d-flex align-items-start mb-3">
                  ...
                  <span>
                    Participated in the initial wave of developers learning and implementing the
                    React.JS library.{" "}
                  </span>
                </li>
                <li className="d-flex align-items-start mb-3">
                  ...
                  <span>
                    Tested, debugged, and shipped 10s of 1000s of lines of code to various
                    development teams. This lead to 100% bug-free deployment.{" "}
                  </span>
                </li>
                <li className="d-flex align-items-start mb-3">
                  <span className="avatar-text avatar-sm bg-soft-success text-success me-3">
                  ...
                  <span>
                    Introduced Kanban Board style ticketing system to promote highly efficient
                    asynchronous and synchronous work, increasing efficiency by 12%.{" "}
                  </span>
                </li>
                <li className="d-flex align-items-start mb-3">
                  <span className="avatar-text avatar-sm bg-soft-success text-success me-3">
                  ...
                  <span>
                    Utilized HTML, CSS, and JavaScript to create 100+ responsive landing pages for
            ...
            <div className="card-body">
              <div className="row">
                <div className="col-xxl-6">
                  ...
                  <Card title="How to integrate new web applications?" link="#" />
                  <Card title="How do I set the geometry of an object?" link="#" />
                </div>
                <div className="col-xxl-6">
                  <Card title="How to upload data to the system?" link="#" />
                  <Card title="How to draw a land plot on a map?" link="#" />
