...
const EmailList = ({
  ...
  return (
    <div className="single-items chat-single-item">
      ...
      <div onClick={handleDetailsShow} className="d-flex align-items-center gap-4 w-100 item-info">
      ...
      <div className="d-flex align-items-center justify-content-end wd-150 gap-3 item-data">
        <div className="fs-11 fw-medium text-muted text-uppercase d-none d-sm-block item-time">
          {date}
        </div>
