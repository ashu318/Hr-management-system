...
const EstimateStatisticsTwo = () => {
  return (
    <>
      {reportSalesStatisticsData.map(
        ({ id, last_month_sales, revenue, running_month_sales, title, icon }) => {
          ...
          const badgeClass = isRunningGreater
                  ...
                  <div className="hstack justify-content-between">
                    <div>
                      ...
                      <p className="fs-12 text-muted mb-0">
                        vs last month:{" "}
                        <span className="fw-semibold text-dark">${last_month_sales} USD</span>
                      </p>
                    </div>
