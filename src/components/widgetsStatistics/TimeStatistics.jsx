          ...
          <div key={id} className="col-xxl-3 col-md-6">
            <div className="card stretch stretch-full time-sheet-card">
              <div className="card-body">
                ...
                <h4>
                  <span className="counter">{time.hour}</span>H :{" "}
                  <span className="counter">{time.minute}</span>M
                </h4>
                <div className="hstack gap-2 mt-3">
                  <span
                    className={`fs-11 badge bg-gray-100 ${isTrendUp ? "text-success" : "text-danger"}`}
                  >
                    <i className="fs-12 me-1">
                      {isTrendUp ? <FiTrendingUp /> : <FiTrendingDown />}
                    </i>
                    <span>{progress}%</span>
                  </span>
