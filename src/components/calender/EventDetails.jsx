  ...
  return (
    <>
      <div className="edit-delete-modal">
        ...
        <p className="edit-delete-modal-location mb-0">
          <FiMapPin size={14} /> {selectedEvent.extendedProps.details.location}
        </p>
        <p className="edit-delete-modal-category mb-0">
          {" "}
          <span style={{ background: selectedEvent.extendedProps.details.dotColor }}></span>{" "}
          {selectedEvent.extendedProps.category}
        </p>
        <p className="edit-delete-modal-posotion mb-0">
          <FiSun size={14} /> {selectedEvent.extendedProps.details.position}
        </p>

        <p className="edit-delete-modal-details">{selectedEvent.extendedProps.details.details}</p>

        <div className="modal-buttons">
          <button onClick={handleEditEvent} className="btn btn-primary wd-150 d-flex gap-2">
            {" "}
            <FiEdit size={13} /> Edit
          </button>
          <button onClick={handleDeleteEvent} className="btn btn-danger wd-150 d-flex gap-2">
