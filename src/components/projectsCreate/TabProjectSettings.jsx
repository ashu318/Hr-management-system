      ...
      <form id="project-settings">
        <fieldset>
          ...
          <fieldset>
            ...
            <fieldset>
              <div className="row">
                {visibleTabsList.map(({ id, label, isChecked }) => (
                  <CheckboxCard
                    key={id}
                    id={id}
                    label={label}
          ...
          <fieldset>
            ...
            <fieldset>
              {projectControlList.map(({ id, label, isChecked }) => (
                <CheckboxCard key={id} id={id} label={label} isChecked={isChecked} />
              ))}
            </fieldset>
          </fieldset>
        </fieldset>
  ...
  return (
    <div className={className}>
      <div className="custom-control custom-checkbox mb-3">
        ...
        />
        <label className="custom-control-label c-pointer" htmlFor={id}>
          {label}
        </label>
      </div>
    </div>
