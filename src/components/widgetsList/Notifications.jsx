...
const trendingItemsData = [
  {
    ...
    title: "Best Offers",
    description: "Check our best new offers",
  },
  {
    color: "primary",
    icon: "feather-clipboard",
    title: "Recent Invoices",
    description: "Whole documentations",
  },
  {
    color: "warning",
    icon: "feather-star",
    title: "Recent Feedback",
    description: "All feeback from your clients",
  },
  {
    color: "danger",
    icon: "feather-message-square",
    title: "Support Request",
    description: "All request from your clients",
  },
  {
    color: "teal",
    icon: "feather-shopping-cart",
    title: "New Order",
    description: "All new order from your clients",
  },
];
  ...
  return (
    <div className="col-xxl-4 col-lg-6">
      ...
      >
              ...
              <Fragment key={index}>
                <div className="d-flex align-items-center justify-content-between">
                  <div className="d-flex align-items-center">
                    <div
                      className={`avatar-text avatar-lg bg-soft-${color} text-${color} border-soft-${color} rounded me-3`}
                    >
                ...
                {trendingItemsData.length - 1 === index ? (
                  ""
                ) : (
        ...
        <a href="#" className="card-footer fs-11 fw-bold text-uppercase text-center">
          Refresh
        </a>
