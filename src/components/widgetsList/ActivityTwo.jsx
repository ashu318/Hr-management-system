    ...
    <li className={`d-flex justify-content-between feed-item feed-item-${type}`}>
      <div>
        ...
        <span className="text">
          {text}
          {badge ? (
            <a href={linkHref} className={`badge bg-soft-${badgeColor} text-${badgeColor} ms-1`}>
              {" "}
              {linkText}
            </a>
          ) : (
            <a href={linkHref} className="fw-bold text-primary">
              {" "}
              {linkText}
            </a>
          )}
      ...
      <div className="ms-3 d-flex gap-2 align-items-center">
        <a
          ...
          data-title="Make Read"
        >
          <FiCheck size={12} strokeWidth={1.6} />
        </a>
        <a
          href="#"
          className="avatar-text avatar-sm"
