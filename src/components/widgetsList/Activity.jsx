            ...
            {profileActivityData2.map(({ badges, color, description, timeAgo, title }, index) => (
              <li key={index} className={`feed-item feed-item-${color}`}>
                <div className="d-flex gap-4 justify-content-between">
                          ...
                          <Fragment key={index}>
                            {badge.users ? (
                              <div className="img-group lh-0 ms-2 justify-content-start">
                                ...
                                <span className="fs-11 text-muted ms-3 text-truncate-1-line">
                                  6.78K+ members connections
                                </span>
                              </div>
                            ) : (
                              <a
                                href="#"
                                className={`badge border border-dashed border-gray-500 text-${badge.color}`}
                              >
                                {badge.text}
                              </a>
                            )}
                  ...
                  <div className="fs-10 fw-medium text-uppercase text-muted text-nowrap">
                    {timeAgo}
                  </div>
                </div>
              </li>
