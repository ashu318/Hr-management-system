              ...
              <Fragment key={index}>
                <div className="pd-x-30 pd-y-15 d-flex justify-content-between">
                  <div className="d-flex">
                    <div
                      className={`avatar-text avatar-lg rounded bg-soft-${color} text-${color} border-soft-${color}`}
                    >
                      {name.substring(0, 1)}
                    </div>
                    <div className="ps-3">
                  ...
                  <div className="text-end">
                    <div className="d-flex gap-1 mb-1">
                      {Array.from({ length: rating }).map((_, i) => (
                        <i key={i} className="text-warning fs-11">
                          <FaStar />
                        </i>
                      ))}
                    </div>
