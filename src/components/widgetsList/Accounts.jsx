...
const accountsData = [
  {
    imageSrc: "/images/payment/mastercard.svg",
    cardName: "Mastercard",
    amount: "$3,365",
    lastDigits: "3456",
  },
  {
    imageSrc: "/images/payment/visa.svg",
    cardName: "Visa Card",
    amount: "$2,245",
    lastDigits: "4236",
  },
  {
    imageSrc: "/images/payment/discover.svg",
    cardName: "Discover",
    amount: "$1,687",
    lastDigits: "5236",
  },
  {
    imageSrc: "/images/payment/american-express.svg",
    cardName: "AM Express",
    amount: "$2,558",
    lastDigits: "4235",
  },
  {
    imageSrc: "/images/payment/jcb.svg",
    cardName: "JCB Card",
    amount: "$2,359",
    lastDigits: "3457",
  },
                ...
                <div className="d-flex align-items-center justify-content-between">
                  <div className="hstack gap-3 align-items-end">
                    <Image
                      ...
                      src={imageSrc}
                      alt="img"
                      className="img-fluid wd-50"
                    />
                    <div className="ac-card">
                      <a href="#" className="d-block">
                        {cardName} <small className="fw-medium text-muted">({amount})</small>
                      </a>
