      ...
      >
        ...
        <div className="card-body custom-card-action p-0">
          <ul className="nav-tab-items-wrapper nav nav-justified invoice-overview-tab-item">
            ...
            <li className="nav-item">
              <a href="#" className="nav-link" data-bs-toggle="tab" data-bs-target="#estimateTab">
                Estimate
              </a>
            </li>
            <li className="nav-item">
              <a href="#" className="nav-link" data-bs-toggle="tab" data-bs-target="#proposalTab">
                Proposal
              </a>
            </li>
          </ul>
