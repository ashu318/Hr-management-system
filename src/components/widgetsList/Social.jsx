  ...
  return (
    <div className="col-xxl-4">
      ...
      >
        ...
        <div className="card-body custom-card-action">
          {socialLinks.map(({ followers, icon, link, text }, index) => (
            <div key={index} className="d-flex align-items-center mb-4 pb-2">
              ...
              <a href={link} target="_blank" className="text-truncate-1-line">
                {text}
                <span className="text-gray-500">themeOcean</span>
              </a>
        ...
        <Link href="#" className="card-footer fs-11 fw-bold text-uppercase text-center py-4">
          {" "}
          <i className="me-2">
            <FiPlus size={16} />
          </i>{" "}
