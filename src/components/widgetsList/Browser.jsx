        ...
        <div className="card-body custom-card-action p-0">
          <div className="table-responsive">
            <table className="table table-hover mb-0">
              <tbody>
                {browserList.map(
                  ({ browser_name, id, total_user, icon, iconColor, progressColor }) => (
                    <tr key={id}>
                      <td>
                        <Link href="#">
                          <i className={`fs-16 text-primary me-2 text-${iconColor}`}>
                            {getIcon(icon)}
                          </i>
                      ...
                      <td>
                        <span className="text-end d-flex align-items-center m-0">
                          ...
                          <HorizontalProgress
                            progress={total_user}
                            barHeight="w-100 ht-5"
                            barColor={`bg-${progressColor}`}
                          />
                        </span>
                      </td>
                    </tr>
