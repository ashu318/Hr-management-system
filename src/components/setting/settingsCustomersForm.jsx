          ...
          <div className="card-body">
            <div className="mb-5">
              ...
              <small className="form-text text-muted">
                Company field is required? [Ex: Yes/No]
              </small>
            </div>
            <div className="mb-5">
              ...
              />
              <small className="form-text text-muted">
                Company requires the usage of the VAT Number field [Ex: Yes/No]
              </small>
            </div>
            <div className="mb-5">
              ...
              />
              <small className="form-text text-muted">
                Allow customers to register [Ex: Yes/No]
              </small>
            </div>
            <div className="mb-5">
              <label className="form-label">
                Allow primary contact to manage other customer contacts{" "}
              </label>
              <SelectDropdown
                options={options}
                defaultSelect={"no"}
              ...
              />
              <small className="form-text text-muted">
                Allow primary contact to manage other customer contacts [Ex: Yes/No]
              </small>
            </div>
            <div className="mb-5">
              ...
              />
              <small className="form-text text-muted">
                Enable Honeypot spam validation [Ex: Yes/No]
              </small>
            </div>
            <div className="mb-5">
              <label className="form-label">
              ...
              />
              <small className="form-text text-muted">
                Require registration confirmation from administrator after customer register [Ex:
                Yes/No]
              </small>
            </div>
            <div className="mb-5">
              <label className="form-label">
                {" "}
                Contacts see only own files uploaded in customer area (files uploaded in customer
                profile){" "}
              </label>
              <SelectDropdown
                options={options}
            ...
            <div className="mb-5">
              ...
              />
              <small className="form-text text-muted">
                Allow contacts to delete own files uploaded from customers area [Ex: Yes/No]
              </small>
            </div>
            <div className="mb-5">
            ...
            <div className="mb-5">
              ...
              />
              <small className="form-text text-muted">
                Allow primary contact to view/edit billing &amp; shipping details [Ex: Yes/No]
              </small>
            </div>
            <div className="mb-5">
              <label className="form-label">
              ...
              />
              <small className="form-text text-muted">
                Allow knowledge base to be viewed without registration [Ex: Yes/No]
              </small>
            </div>
            <div className="mb-5">
              ...
              <MultiSelectTags
                ...
                defaultSelect={[
                  ...
                  permissionsOptions[2],
                  permissionsOptions[3],
                  permissionsOptions[4],
                  permissionsOptions[5],
                ]}
              />
              <small className="form-text text-muted">
                Default contact permissions [Ex: USD/EUR/RUB]
              </small>
            </div>
            <TextAreaTopLabel
...
{vat_number_with_label}"
              info={
                "Customer Information Format (PDF and HTML) [Ex: {company_name}, {customer_id}, {street}, {city}, {state}, {zip_code}, {country_code}, {country_name}, {phone}, {vat_number}, {vat_number_with_label}]"
              }
            />
          </div>
        </div>
