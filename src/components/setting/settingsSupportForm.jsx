      ...
      <div className="content-area-body">
        <div className="card mb-0">
          <div className="card-body">
            ...
            <div className="mb-5">
              <label className="form-label">
                Send staff-related ticket notifications to the ticket assignee only{" "}
              </label>
              <SelectDropdown
                options={options}
                defaultSelect={"no"}
            ...
            <div className="mb-5">
              <label className="form-label">
                Automatically assign the ticket to the first staff that post a reply?{" "}
              </label>
              <SelectDropdown
                options={options}
                defaultSelect={"no"}
            ...
            <div className="mb-5">
              <label className="form-label">
                In customers area only show tickets related to the logged in contact (Primary
                contact not applied){" "}
              </label>
              <SelectDropdown
                options={options}
            ...
            <div className="mb-0">
              ...
              />
              <small className="form-text text-muted">
                Try to import only the actual ticket reply (without quoted/forwarded message) [Ex:
                Yes/No]
              </small>
            </div>
          </div>
