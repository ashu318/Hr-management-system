            ...
            <div className="card-body">
              <div className="mb-5">
                ...
                <small className="form-text text-muted">
                  Allow all staff to see all tasks related to projects (includes non-staff) [Ex:
                  Yes/No]
                </small>
              </div>
              <div className="mb-5">
                <label className="form-label">
                  Allow customer/staff to add/edit task comments only in the first hour
                ...
                <small className="form-text text-muted">
                  Allow customer/staff to add/edit task comments only in the first hour
                  (administrators not applied) [Ex: Yes/No]
                </small>
              </div>
              <div className="mb-5">
                <label className="form-label">
                ...
                <small className="form-text text-muted">
                  {" "}
                  Auto assign task creator when new task is created [Ex: Yes/No]
                </small>
              </div>
              <div className="mb-5">
                <label className="form-label">
                ...
                />
                <small className="form-text text-muted">
                  Auto add task creator as task follower when new task is created [Ex: Yes/No]
                </small>
              </div>
              <div className="mb-5">
                <label className="form-label">
                ...
                />
                <small className="form-text text-muted">
                  Stop all other started timers when starting new timer [Ex: Yes/No]
                </small>
              </div>
              <div className="mb-5">
                <label className="form-label">
                  Change task status to In Progress on timer started (valid only if task status is
                  Not Started){" "}
                </label>
                <SelectDropdown
                  options={options}
                ...
                <small className="form-text text-muted">
                  Change task status to In Progress on timer started (valid only if task status is
                  Not Started) [Ex: Yes/No]
                </small>
              </div>
              <div className="mb-5">
                <label className="form-label">
                  Billable option is by default checked when new task is created? (only from admin
                  area){" "}
                </label>
                <SelectDropdown
                  options={options}
              ...
              <div className="mb-5">
                ...
                />
                <small className="form-text text-muted">
                  Default status when new task is created [Ex: Auto/Testing/Completed]
                </small>
              </div>
              <div className="mb-0">
                ...
                />
                <small className="form-text text-muted">
                  Default Priority [Ex: Low/Medium/High/Urgent]
                </small>
              </div>
            </div>
          </div>
