            ...
            <div className="card-body">
              ...
              <div className="mb-5">
                <label className="form-label">
                  Mail Engine <span className="text-danger">*</span>
                </label>
                <SelectDropdown
                  options={mailEngine}
                ...
                <small className="form-text text-muted">
                  Mail Engine [Ex: HPMailer/CodeIgniter]
                </small>
              </div>
              <div className="mb-5">
                ...
                />
                <small className="form-text text-muted">
                  Email Protocol [Ex: Mail/SMTP/Sendmail]
                </small>
              </div>
              <InputTopLabel
                label={"Email"}
              ...
              <div className="mb-5">
                <label className="form-label">
                  ...
                  <span
                    data-toggle="tooltip"
                    data-title="To speed up the emailing process, the system will add the emails in queue and will send them via cron job, make sure that the cron job is properly configured in order to use this feature."
                  >
                    <i className="fs-13 text-muted lh-1">
                      <FiInfo />
                    </i>
                  </span>
                </label>
              ...
              <div className="mb-0">
                <label className="form-label">
                  ...
                  <span
                    data-toggle="tooltip"
                    data-title="Most likely you will encounter problems with the email queue if the system needs to add big files to the queue."
                  >
                    <i className="fs-13 text-muted lh-1">
                      <FiInfo />
                    </i>
                ...
                />
                <small className="form-text text-muted">
                  Do not add emails with attachments in the queue? [Ex: YES/NO]
                </small>
              </div>
              <hr className="my-5" />
              <div className="mb-5">
              ...
              <div className="mb-0">
                ...
                <small className="form-text text-muted">
                  Send Test Email [Ex: test_1@email.com, test_2@email.com, test_3@email.com]
                </small>
              </div>
            </div>
          </div>
