            ...
            <div className="card-body">
              <div className="mb-5">
                ...
                <small className="form-text text-muted">
                  Require client to be logged in to view contract [Ex: Yes/No]
                </small>
              </div>
              <div className="mb-5">
                <label className="form-label">
                ...
                />
                <small className="form-text text-muted">
                  Show setup menu item only when hover with mouse on main sidebar area [Ex: Yes/No]
                </small>
              </div>
              <div className="mb-5">
                ...
                />
                <small className="form-text text-muted">
                  Show help menu item on setup menu [Ex: Yes/No]
                </small>
              </div>
              <div className="mb-5">
                <label className="form-label">
                ...
                />
                <small className="form-text text-muted">
                  Allow non-admin staff members to create Lead Status in Lead create/edit area? [Ex:
                  Yes/No]
                </small>
              </div>
              <div className="mb-5">
                ...
                />
                <small className="form-text text-muted">
                  Allow non-admin staff members to create Lead Source in Lead create/edit area? [Ex:
                  Yes/No]
                </small>
              </div>
              <div className="mb-5">
                <label className="form-label">
                  Allow non-admin staff members to create Customer Group in Customer create/edit
                  area?{" "}
                </label>
                <SelectDropdown
                  options={options}
              ...
              <div className="mb-5">
                ...
                />
                <small className="form-text text-muted">
                  Allow non-admin staff members to create Service in Ticket create/edit area? [Ex:
                  Yes/No]
                </small>
              </div>
              <div className="mb-5">
                ...
                />
                <small className="form-text text-muted">
                  Allow non-admin staff members to save predefined replies from ticket message [Ex:
                  Yes/No]
                </small>
              </div>
              <div className="mb-5">
                <label className="form-label">
                  Allow non-admin staff members to create Contract type in Contract create/edit
                  area?{" "}
                </label>
                <SelectDropdown
                  options={options}
              ...
              <div className="mb-5">
                <label className="form-label">
                  Allow non-admin staff members to create Expense Category in Expense create/edit
                  area?{" "}
                </label>
                <SelectDropdown
                  options={options}
              ...
              <div className="mb-5">
                ...
                />
                <small className="form-text text-muted">
                  Enable Real Time Notifications [Ex: Yes/No]
                </small>
              </div>
              <div className="mb-0">
                ...
                />
                <small className="form-text text-muted">
                  Enable Desktop Notifications [Ex: Yes/No]
                </small>
              </div>
              <hr className="my-5" />
              <div className="mb-5">
              ...
              <div className="mb-5">
                ...
                />
                <small className="form-text text-muted">
                  Require digital signature and identity confirmation on accept [Ex: Yes/No]
                </small>
              </div>
              <div className="mb-0">
                <label className="form-label">
