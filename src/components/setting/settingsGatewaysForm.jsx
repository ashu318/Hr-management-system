    ...
    <>
      ...
      <div className="mb-5">
        ...
        <small className="form-text text-muted">
          Allow primary contact to update stored credit card token? [Ex: Yes/No]
        </small>
      </div>
      <div className="mb-5">
        <label className="form-label">Currencies</label>
...
const TwoCheckout = () => {
  ...
  return (
    <>
      <InputTopLabel label={"Merchant Code"} placeholder={"Merchant Code"} info={"Merchant Code"} />
      <InputTopLabel label={"Secret Code"} placeholder={"Secret Code"} info={"Secret Code"} />
      <div className="mb-5">
        <label className="form-label">Status</label>
        <SelectDropdown
          options={status}
