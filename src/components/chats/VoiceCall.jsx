...
const VoiceCall = () => {
  return (
    <div
      className="modal fade calling-modal-screen"
      id="voiceCallingModalScreen"
      data-bs-backdrop="static"
      aria-hidden="true"
      aria-labelledby="voiceCallingModalScreen"
      tabIndex="-1"
    >
              ...
              <div className="d-flex align-items-center justify-content-center flex-column voice-call-content">
                <div className="wd-150 ht-150">
                  <img
                    ...
                    className="rounded-circle border border-5 img-fluid animation-infinite"
                    alt="image"
                  />
                </div>
