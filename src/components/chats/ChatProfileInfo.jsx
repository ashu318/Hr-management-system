...
const ChatProfileInfo = () => {
  return (
    <div
      className="offcanvas offcanvas-end userProfileDetails"
      ...
      <div className="offcanvas-body p-0">
        <div className="p-4 text-center position-relative">
          <img
            ...
            alt="img"
            className="wd-100 ht-100 rounded-circle border border-5 img-fluid"
          />
          <h2 className="text-dark fs-13 fw-bold mt-3 mb-0">
            Alexandra Della
            <i
              className="text-success fs-11 ms-1"
              data-toggle="tooltip"
            ...
            <i
              className="text-warning fs-11 ms-1"
              data-toggle="tooltip"
              data-bs-trigger="hover"
              data-title="Feedback"
            >
            ...
            <i
              className="text-primary fs-11 ms-1"
              data-toggle="tooltip"
              data-bs-trigger="hover"
          ...
          <a href="#" className="btn btn-sm btn-primary d-inline-block rounded-pill">
            Software Engineer
          </a>
          <div className="d-flex justify-content-center mt-3 social-profile">
            <a
              href="#"
              className="avatar-text avatar-md me-1"
              data-toggle="tooltip"
              data-bs-trigger="hover"
              data-title="Github"
              aria-label="Github"
            ...
            >
              <FiInstagram strokeWidth={1.6} />
            </a>
          </div>
        </div>
        {/* Info */}
        <a
          className="py-2 px-4 fs-12 fw-bold d-block bg-gray-200 border-top border-bottom sticky-top sticky-bar"
        ...
        <div className="p-4 fs-13 collapse show" id="PersonalInfo">
          ...
          <div className="d-flex align-items-start mb-3">
            ...
            <div>
              <span className="fw-medium text-muted">Recent activity by </span>{" "}
              <a href="#" className="ac-info-sidebar-open-trigger">
                Alexandra Della
              </a>
            </div>
          </div>
          ...
          <div className="d-flex align-items-start about-text">
            ...
            <p className="fs-12 text-muted mb-0 text-truncate-2-line">
              The story is about a weary detective who can"t resist a fight. It takes place in a
              jungle commonwealth on a world of forbidden magic. The threat of bioterrorism plays a
        ...
        <div className="p-4 collapse show" id="Attachments">
          <AttachmentsCard
            ...
            fileSize={"40.65/MB"}
            img={"/images/file-icons/zip.png"}
            className="mb-4"
          />
          <AttachmentsCard
            fileName={"Document.png"}
            fileSize={"480.148/KB"}
            img={"/images/file-icons/png.png"}
            className="mb-4"
          />
          <AttachmentsCard
            fileName={"Project.psd"}
            fileSize={"32.423/MB"}
            img={"/images/file-icons/psd.png"}
            className="mb-4"
          />
          <AttachmentsCard
            fileName={"Photos.pdf"}
            fileSize={"48.254/MB"}
            img={"/images/file-icons/pdf.png"}
          />
        </div>
        {/* / Attachments */}
        {/* Medias */}
...
const SkillsCard = ({ skillName, progress, className, progressColor }) => {
  return (
    <div className={className}>
      <div className="d-flex align-items-center mb-1 fs-11 fw-medium text-uppercase">
        {skillName} <span className="ms-auto">{progress}%</span>
      </div>
  ...
  return (
    <li className="d-flex align-items-center justify-content-between chat-single-item">
      <div className="d-flex align-items-center">
        ...
        <div className="lh-sm">
          <h2 className="fs-13 fw-bold mb-0">
            <a href="#">{name}</a>
          </h2>
      ...
      <a
        href="#"
        className="btn btn-sm btn-light-brand ml-auto d-none d-sm-block"
        onClick={handleClick}
      >
        Follow
      </a>
...
const AttachmentsCard = ({ img, fileName, fileSize, className }) => {
  return (
    <div
      className={`text-dark d-flex align-items-center justify-content-between border rounded-3 ${className}`}
    >
      <div className="d-flex align-items-center">
        ...
        <div className="d-block ms-3">
          <a href="#" className="fs-13 fw-bold d-block">
            {fileName}
          </a>
