...
const CallAction = ({ isVideoCall }) => {
  ...
  return (
    <div className="gap-2 d-flex align-items-center justify-content-center calling-receiver-action">
      <a
        href="#"
        className="btn btn-icon bg-white rounded-circle rounded-circle"
        data-toggle="tooltip"
        data-bs-trigger="hover"
        data-title="Mute Call"
      >
      ...
      <a
        ...
        data-toggle="tooltip"
        data-bs-trigger="hover"
        data-title={`${isVideoCall ? "Switch Voice" : "Switch Video"}`}
      >
        {isVideoCall ? (
          <span
            className="btn btn-icon bg-white rounded-circle rounded-circle"
      ...
      <a
        ...
        href="#"
        className="call-received btn btn-icon btn-success rounded-circle"
        data-toggle="tooltip"
        data-bs-trigger="hover"
        data-title="Received Call"
        style={{ display: callEnd ? "none" : "block" }}
      >
        <FiPhoneCall size={16} strokeWidth={1.8} />
      </a>
      <a
        href="#"
        className="btn btn-icon btn-danger rounded-circle call-ended"
        data-toggle="tooltip"
        data-bs-trigger="hover"
        data-title="End Call"
        data-bs-dismiss="modal"
        style={{ display: callEnd ? "block" : "none" }}
      >
