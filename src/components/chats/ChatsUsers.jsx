      ...
      <PerfectScrollbar>
        ...
        <div className="content-sidebar-body">
          ...
          <div className="content-sidebar-items">
            {userList().map(
              ({ id, user_img, user_name, active_time, is_active, is_message_read }) => {
                return (
                  <div
                    key={id}
                  ...
                  >
                    ...
                    <div className="ms-3 item-desc">
                      <div className="w-100 d-flex align-items-center justify-content-between">
                        <a href="#" className="hstack gap-2 me-2">
                          ...
                          <div
                            ...
                            style={{ background: is_active.color }}
                          ></div>
                      ...
                      <p
                        className={`fs-12 fw-semibold mt-2 mb-0 text-truncate-2-line ${is_message_read ? "" : "text-dark"}`}
                      >
                        Lorem ipsum dolor sit amet, consec tetuer adipi scing elit aenean commodo
                        ipsum dolor sit amet, consec tetuer adipi scing elit aenean commodo
                      </p>
                    </div>
                  </div>
                );
