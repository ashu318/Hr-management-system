  ...
  return (
    <div className="d-flex align-items-center justify-content-between px-4 py-3">
      <div className="d-flex align-items-center justify-content-center content-sub-header-left chat-calling-info">
        ...
        <div>
          <a href="#" className="fs-13 fw-bold d-flex align-items-center">
            Erna Serpa
          </a>
      ...
      <div className="d-flex align-items-center">
        <a
          href="#"
          className="avatar-text avatar-md me-2 d-none d-lg-flex chat-message-sidebar-toggle"
          data-toggle="tooltip"
        ...
        <a
          href="#"
          className="avatar-text avatar-md bg-soft-danger d-flex close-icon call-ended"
