...
const leadInfoData = [
  ...
  },
  {
    ...
    content: (
      <>
        CEO, Founder at <a href="#">Theme Ocean</a>
      </>
    ),
  },
  {
    ...
    <div className="tab-pane fade show active" id="profileTab" role="tabpanel">
      ...
      <div className="card card-body general-info">
        ...
        <div className="row mb-4">
          ...
          <div className="col-lg-10 hstack gap-1">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Molestiae, nulla veniam, ipsam
            nemo autem fugit earum accusantium reprehenderit recusandae in minima harum vitae
            doloremque quasi aut dolorum voluptate. Minima, deleniti.Lorem ipsum, dolor sit amet
            consectetur adipisicing elit. Molestiae, nulla veniam, ipsam nemo autem fugit earum
            accusantium reprehenderit recusandae in minima harum vitae doloremque quasi aut dolorum
            voluptate.
          </div>
        </div>
      </div>
