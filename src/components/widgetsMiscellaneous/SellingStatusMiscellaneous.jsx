...
const salesInfoData = [
  {
    ...
    description: "10+ weekly bestseller",
  ...
  },
  {
    ...
    description: "10+ feature sellers",
    icon: "feather-award",
    color: "success",
    avatarDataArray,
  },
  {
    ...
    description: "10+ average bestseller",
            ...
            <div key={index}>
              <div className="d-flex align-items-center justify-content-between">
                <div className="d-flex align-items-center gap-3">
                  <div
                    className={`avatar-text avatar-lg bg-soft-${info.color} text-${info.color} border-soft-${info.color} rounded`}
                  >
