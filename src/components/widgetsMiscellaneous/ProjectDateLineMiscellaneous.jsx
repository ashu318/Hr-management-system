...
const projectData = [
  {
    project_name: "NFT Mobile Apps Developemnt",
    progress: "40",
    progress_color: "#ea4d4d",
    deadiline: "20 days left",
  },
  {
    project_name: "NFT Mobile Apps Developemnt",
    progress: "85",
    progress_color: "#3454d1",
    deadiline: "18 days left",
  },
  {
    project_name: "NFT Mobile Apps Developemnt",
    progress: "50",
    progress_color: "#ffa21d",
    deadiline: "16 days left",
  },
  {
    project_name: "NFT Mobile Apps Developemnt",
    progress: "75",
    progress_color: "#17c666",
    deadiline: "10 days left",
  },
];
      ...
      <div className="card stretch stretch-full">
        <div className="card-body">
          <div className="hstack justify-content-between mb-4 pb-">
            ...
            <Link href="#" className="btn btn-light-brand">
              View Alls
            </Link>
          </div>
                  ...
                  <div className="hstack justify-content-between gap-4">
                    <div>
                      ...
                      <div className="fs-12 text-muted">
                        <span className="text-dark fw-medium">Deadiline:</span> {deadiline}
                      </div>
                    </div>
