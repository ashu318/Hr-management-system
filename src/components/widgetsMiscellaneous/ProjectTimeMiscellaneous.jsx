...
const ProjectTimeMiscellaneous = () => {
  ...
  return (
    <>
      {data.map(
        ({ progress, projectsList, progressColor, footerLabelLeft, footerLabelRight }, index) => (
          <TaskCard
            key={index}
            progress={progress}
    ...
    <div className="col-xxl-4">
      <div className="card stretch stretch-full">
        ...
        <div className="card-body">
          {projectsList.map(
            ({ taskName, completedTasks, totalTasks, bgColor, borderColor, time }, index) => (
                ...
                <div className="hstack gap-3 justify-content-between">
                  <div className="hstack gap-3">
                    ...
                    <div className={`ps-3 border-start border-3 ${borderColor} rounded`}>
                      <a href="#" className="fw-bold text-truncate-1-line">
                        {taskName}
                      </a>
        ...
        <div className="card-footer hstack justify-content-around">
          <div className="text-center">
            <a href="#" className="fs-16 fw-bold">
              {footerLabelLeft.title}
            </a>
