      ...
      <div className="card stretch stretch-full">
        <div className="card-body">
          <div className="row g-4">
            {recentDealData.map(
              ({ clossing_date, deal_name, deal_price, dealr_img, dealr_name }, index) => (
                  ...
                  <div className="border border-dashed border-gray-5 p-4 rounded-3 gap-4 text-center">
                    ...
                    <div className="mt-4">
                      <p className="fs-12 text-muted mb-1">
                        Clossing date:{" "}
                        <span className="fs-11 fw-medium text-dark">{clossing_date}</span>
                      </p>
                      <Link href="#" className="fw-bold text-truncate-1-line">
                        {deal_name}
                      </Link>
