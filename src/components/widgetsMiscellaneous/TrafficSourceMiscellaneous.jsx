...
const trafficData = [
  {
    ...
    bgClass: "border-soft-primary",
    text: "Organic Traffics",
    value: "8,865",
  },
  {
    icon: "feather-layers",
    bgClass: "border-soft-warning",
    text: "Referral Traffics",
    value: "6,579",
  },
  {
    icon: "feather-link-2",
    bgClass: "border-soft-danger",
    text: "Affiliates Traffics",
    value: "5,865",
  },
  {
    icon: "feather-bookmark",
    bgClass: "border-soft-success",
    text: "Others Traffics",
    value: "2,354",
  },
];
          ...
          <div className="row g-4">
            {trafficData.map(({ icon, bgClass, text, value }, index) => (
              <div key={index} className="col-6">
                <a
                  href="#"
                  className={`d-block p-4 text-center border border-dashed ${bgClass} rounded position-relative`}
                >
