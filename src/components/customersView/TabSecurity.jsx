    ...
    <div className="tab-pane fade p-4" id="securityTab" role="tabpanel">
      ...
      >
        ...
        <div>
          ...
          <a href="#" className="btn btn-sm btn-danger d-inline-block">
            Learn more
          </a>
          <button
            type="button"
      ...
      <div className="card mt-5">
        <div className="card-body">
          ...
          <div className="my-4 py-2">
            ...
            <div className="mt-3">
              <div className="custom-control custom-checkbox">
                ...
                <label className="custom-control-label c-pointer" htmlFor="acDeleteDeactive">
          ...
          <div className="d-sm-flex gap-2">
            <a href="#" className="btn btn-danger" data-action-target="#acSecctingsActionMessage">
              Delete Account
            </a>
            <a href="#" className="btn btn-warning mt-2 mt-sm-0" onClick={handleClick}>
              Deactiveted Account
            </a>
          </div>
        </div>
  ...
  return (
    <div className="p-4 mb-4 border border-dashed border-gray-3 rounded-1">
      ...
      <div className="form-check form-switch form-switch-sm">
        <label className="form-check-label fw-500 text-dark c-pointer" htmlFor={checkboxId}>
          {label}
        </label>
        <input
