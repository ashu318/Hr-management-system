          ...
          <div className="card-body p-0">
            <div className="px-4 pt-4">
              <div className="d-md-flex align-items-center justify-content-between">
                <div className="mb-4 mb-md-0 your-brand">
                  <label
                    htmlFor="img"
                    className="wd-100 ht-100 mb-0 position-relative overflow-hidden border border-gray-2 rounded"
                  >
                    <img
            ...
            <div className="px-4 row justify-content-between">
              <div className="col-xl-3">
                <div className="form-group mb-3">
                  <label htmlFor="InvoiceLabel" className="form-label">
                    Invoice Label
                  </label>
                  <input
                    type="text"
              ...
              <div className="col-xl-6">
                <div className="form-group mb-3">
                  <label htmlFor="InvoiceProduct" className="form-label">
                    Invoice Product
                  </label>
                  <input
                    type="text"
            ...
            <div className="row px-4 justify-content-between">
              <div className="col-xl-5 mb-4 mb-sm-0">
                ...
                <div className="form-group row mb-3">
                  <label htmlFor="InvoiceName" className="col-sm-3 col-form-label">
                    Name
                  </label>
                ...
                <div className="form-group row mb-3">
                  <label htmlFor="InvoiceEmail" className="col-sm-3 col-form-label">
                    Email
                  </label>
                  <div className="col-sm-9">
                    <input
                ...
                <div className="form-group row mb-3">
                  <label htmlFor="InvoicePhone" className="col-sm-3 col-form-label">
                    Phone
                  </label>
                  <div className="col-sm-9">
                    <input
                ...
                <div className="form-group row">
                  <label htmlFor="InvoiceAddress" className="col-sm-3 col-form-label">
                    Address
                  </label>
                  <div className="col-sm-9">
                    <textarea
              ...
              <div className="col-xl-5">
                ...
                <div className="form-group row mb-3">
                  <label htmlFor="ClientName" className="col-sm-3 col-form-label">
                    Name
                  </label>
                  <div className="col-sm-9">
                    <input
                ...
                <div className="form-group row mb-3">
                  <label htmlFor="ClientEmail" className="col-sm-3 col-form-label">
                    Email
                  </label>
                  <div className="col-sm-9">
                    <input
                ...
                <div className="form-group row mb-3">
                  <label htmlFor="ClientPhone" className="col-sm-3 col-form-label">
                    Phone
                  </label>
                  <div className="col-sm-9">
                    <input
                ...
                <div className="form-group row">
                  <label htmlFor="ClientAddress" className="col-sm-3 col-form-label">
                    Address
                  </label>
                  <div className="col-sm-9">
                    <textarea
            ...
            <div className="px-4 clearfix proposal-table">
                        ...
                        <tr key={index}>
                          ...
                          <td>
                            <input
                              ...
                              defaultValue={qty}
                              onChange={(e) =>
                                handleInputChange(id, "qty", parseInt(e.target.value))
                              }
                            />
                          </td>
                          <td>
                            <input
                              ...
                              defaultValue={price}
                              onChange={(e) =>
                                handleInputChange(id, "price", parseFloat(e.target.value))
                              }
                            />
                          </td>
                          <td>
              ...
              <div className="d-flex justify-content-end gap-2 mt-3">
                <button className="btn btn-sm bg-soft-danger text-danger" onClick={removeItem}>
                  Delete
                </button>
          ...
          <div className="card-body">
            <div className="mb-4 d-flex align-items-center justify-content-between">
              ...
              <div
                ...
                data-toggle="tooltip"
                data-bs-trigger="hover"
                data-title="Grand total invoice"
              >
                <FiInfo />
              </div>
            </div>
              ...
              <table className="table table-bordered" id="tab_logic_total">
                <tbody>
                  ...
                  <tr className="single-item">
                    ...
                    <td className="bg-gray-100 w-25">
                      <input
                        type="number"
                        name="total_amount"
                        id="total_amount"
                        placeholder="0.00"
                        className="form-control border-0 bg-transparent p-0 fw-700 text-dark"
                        readOnly
                        value={total}
                      />
                    </td>
          ...
          <div className="card-body">
            <div className="mb-4 d-flex align-items-center justify-content-between">
              ...
              <div
                ...
                data-toggle="tooltip"
                data-bs-trigger="hover"
                data-title="Select payment methord"
              >
                <FiInfo />
              </div>
            </div>
            ...
            <ul className="nav nav-justified gap-1">
              <li className="nav-item border border-gray-500">
                <a
                  href="#"
                  className="nav-link px-2 active d-flex align-items-center justify-content-center"
                  data-bs-toggle="tab"
                  data-bs-target="#pamymetDebitCardTab"
                >
                  <BsCreditCardFill />
              ...
              <li className="nav-item border border-gray-500">
                <a
                  ...
                  data-bs-toggle="tab"
                  data-bs-target="#pamymetPaypalTab"
                >
                  <BsPaypal />
            ...
            <div className="tab-content mt-4">
              <div className="tab-pane fade show active" id="pamymetDebitCardTab" role="tabpanel">
                ...
                <div className="d-flex gap-3">
                  <div className="form-group">
                    <input
                      type="text"
                      className="form-control input-date-formatting"
                      placeholder="MM/YYYY"
                    />
                  </div>
                  <div className="form-group">
                    <input
                      type="text"
                      className="form-control input-Blocks-formatting"
                      placeholder={686}
                    />
                  </div>
                </div>
              ...
              <div className="tab-pane fade" id="pamymetPaypalTab" role="tabpanel">
                ...
                <p>
                  <a href="http://paypal.com" target="_blank" className="btn btn-primary">
                    <i className="bi bi-paypal me-2" /> Log in my Paypal
                  </a>
                </p>
                <div className="fs-11 text-muted">
                  Note: There are many variations of passages of Lorem Ipsum available, but the
          ...
          <div className="card-body">
            <div className="mb-4 d-flex align-items-center justify-content-between">
              <div>
                ...
                <span className="fs-12 text-muted">
                  Calculate your currency, tax &amp; discount
                </span>
              </div>
              <div
                className="avatar-text avatar-sm"
                data-toggle="tooltip"
                data-bs-trigger="hover"
                data-title="Calculate your currency, tax & discount"
              >
                <FiInfo />
              </div>
            </div>
            ...
            <div className="ps-0 mb-3 form-check form-switch form-switch-sm d-flex align-center justify-content-between">
              <label className="fw-bold text-dark" htmlFor="LateFees">
                <span>Late Fees</span>
                <span className="fs-11 fw-normal text-muted d-block">
                  Late fees for extra charge
                </span>
              </label>
              <input
            ...
            <div className="ps-0 mb-3 form-check form-switch form-switch-sm d-flex align-center justify-content-between">
              <label className="fw-bold text-dark" htmlFor="ClientNote">
                ...
                <span className="fs-11 fw-normal text-muted d-block">
                  Client notes for further query
                </span>
              </label>
        ...
        <div className="card stretch stretch-full">
          <div className="card-body">
            <div className="mb-4 d-flex align-items-center justify-content-between">
              ...
              <a href="#" className="btn btn-light-brand">
                Nevermind
              </a>
            </div>
            <p className="fs-12 text-muted mb-4">
              Are you sure you want to cancel this invoice? Neigther you nor alex will able to make
              any(more) payments on it.
            </p>
            <div className="custom-control custom-checkbox">
              <input
                ...
                defaultChecked
              />
              <label className="custom-control-label c-pointer" htmlFor="notifyMe">
                Notify alex that this invoice was cancelled.
              </label>
            </div>
            <a href="#" className="btn bg-soft-danger text-danger mt-4" onClick={handleClick}>
              Cancel this Invoice
            </a>
          </div>
        </div>
