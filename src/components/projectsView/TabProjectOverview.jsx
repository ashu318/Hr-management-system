              ...
              <div className="me-4">
                <h4 className="mb-4 fw-bold d-flex">
                  <span className="text-truncate-1-line">
                    ...
                    <span className="badge bg-soft-primary text-primary mx-3">In Prograss</span>
                  </span>
                </h4>
              ...
              <div className="w-100">
                <div className="d-flex align-items-center justify-content-between">
                  <a href="#" className="fs-12 fw-medium text-muted">
                    <span className="text-truncate-1-line">
                      Projects In Progress <FiLink2 className="fs-11 ms-1" />
                    </span>
                  </a>
                  <div className="ms-3">
                    <span className="fs-12 text-muted text-truncate-1-line">
                      16/25 Tasks Completed <span className="fs-11 text-muted">(78%)</span>
                    </span>
                  </div>
                </div>
              ...
              <div className="row">
                ...
                <div className="col-md-12">
                  ...
                  <p>
                    ...
                    different CRM applications available, ranging from simple contact management
                    tools to more sophisticated platforms that integrate with other business
                    systems.
                  </p>
                  ...
                  <ul>
                    <li>
                      Contact Management: Allows organizations to store and manage customer data,
                      including names, addresses, phone numbers, and email addresses.
                    </li>
                    <li>
                      Sales Management: Helps organizations manage their sales pipeline, track leads
                      and deals, and analyze sales performance.
                    </li>
                    <li>
                      Marketing Automation: Helps organizations automate their marketing processes,
                      including email marketing, social media campaigns, and lead generation.
                    </li>
                    <li>
                      Customer Service and Support: Allows organizations to track and manage
                      customer service requests and provide support to customers via various
                      channels.
                    </li>
                    <li>
                      Analytics and Reporting: Provides insights into customer behavior, sales
                      trends, and other key metrics that help organizations make data-driven
                      decisions.
                    </li>
                  </ul>
                  <p className="mb-0">
                    Some popular CRM applications include Salesforce, Microsoft Dynamics 365,
                    HubSpot, Zoho CRM, and Freshsales. The choice of CRM application depends on an
